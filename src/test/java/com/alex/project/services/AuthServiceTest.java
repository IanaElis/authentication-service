...
public class AuthServiceTest {
    ...
    class AuthServiceLoginTests{
        ...
        void successLogin() {
            ...
            when(tokenGenerator.jwtGenerator(user.getUsername(), Role.USER, 1L)).thenReturn("token");
            ...
            try (MockedStatic<BcryptUtil> mocked = mockStatic(BcryptUtil.class)) {
                ...
                verify(tokenGenerator).jwtGenerator(user.getUsername(), Role.USER, 1L);
            }
        }
    ...
    class AuthServiceRegistrationTests{
        ...
        void successRegistration(){
            ...
            when(tokenGenerator.jwtGenerator(registrationDto.getUsername(), Role.USER, 1L)).thenReturn("token");
