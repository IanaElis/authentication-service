...
You can then execute your native executable with: `./target/authentication-service-1.0-SNAPSHOT-runner`
...
- Apicurio Registry - Avro ([guide](https://quarkus.io/guides/kafka-schema-registry-avro)): Use Apicurio as Avro schema
  registry
